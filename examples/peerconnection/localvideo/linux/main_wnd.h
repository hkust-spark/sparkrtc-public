...
#ifndef EXAMPLES_PEERCONNECTION_LOCALVIDEO_LINUX_MAIN_WND_H_
#define EXAMPLES_PEERCONNECTION_LOCALVIDEO_LINUX_MAIN_WND_H_
...
#endif  // EXAMPLES_PEERCONNECTION_LOCALVIDEO_LINUX_MAIN_WND_H_
