...
#ifndef EXAMPLES_PEERCONNECTION_LOCALVIDEO_CONDUCTOR_H_
#define EXAMPLES_PEERCONNECTION_LOCALVIDEO_CONDUCTOR_H_
...
#endif  // EXAMPLES_PEERCONNECTION_LOCALVIDEO_CONDUCTOR_H_
